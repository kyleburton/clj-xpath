...
This function takes xml that is of one of the followng types and returns a Document:  String, byte array or org.w3c.dom.Document.

h3. <code>($x xpath-expression doc) => (map [...])</code>
