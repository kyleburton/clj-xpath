...
The build creates a REPL script (<code>bin/repl</code>) that you can use to quickly try the library out:
...
nil
user=> (slurp* "http://github.com/kyleburton/clj-xpath/raw/master/pom.xml")
#'user/xdoc
user=> ($x:tag "/*" xdoc)
:project
...
These functions apply the xpath expresskon to the given document and return a sequence of the requested property.
...
This function takes xml that is of one of the followng types and returns a Document:  String, byte array or org.w3c.dom.Document.  In cases of repeated usage of the document (eg: executing multiple xpath expressions against the same document) this will improve performance.
...
This will create the <code>clj-xpath-1.0-jar-with-dependencies.jar</code> jar in the target directory.
...
(add-to-list 'slime-lisp-implementations
             '(clj-xpath ("/Users/kburton/personal/projects/sandbox/clj-xpath/target/../bin/repl")
