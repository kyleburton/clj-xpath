...
* @($x:tag  "//library")@: returns the single node found, throwing an exception if 0 or more than 1 are found.
* @($x:tag? "//library")@: returns the single node found or nil, throwing an exception if than 1 are found.
